...
void main() {
  testWidgets(
    'MediaDetailPage builds correctly and handles video view layout',
    (WidgetTester tester) async {
      // 顶栏收藏入口依赖收藏服务，需确保已在测试容器中注册
...
''',
  ...
  testWidgets(
    'MediaDetailPage top bar has no bottom border line and renders dark theme title cleanly',
    (WidgetTester tester) async {
